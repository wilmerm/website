    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(blank=True, decimal_places=2, max_digits=17, null=True, verbose_name='Importe')),
                ('tax', models.DecimalField(blank=True, decimal_places=2, max_digits=17, null=True, verbose_name='Impuestos')),
                ('total', models.DecimalField(blank=True, decimal_places=2, max_digits=17, null=True, verbose_name='Total')),
