    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_network_name', models.CharField(choices=[('facebook', 'Facebook'), ('instagram', 'Instagram'), ('linkedin', 'LinkedIn'), ('pinterest', 'Pinterest'), ('snapchat', 'Snapchat'), ('telegram', 'Telegram'), ('tumblr', 'Tumblr'), ('twitter', 'Twitter'), ('vkontakte', 'Vkontakte'), ('whatsapp', 'Whatsapp'), ('youtube', 'Youtube')], max_length=20, unique=True, verbose_name='Red social')),
